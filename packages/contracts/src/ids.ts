...
export type AdminSessionId = Branded<string, 'AdminSessionId'>;
...
export type ProductCategoryId = Branded<string, 'ProductCategoryId'>;
export type ServiceAddonId = Branded<string, 'ServiceAddonId'>;
...
export const productCategoryIdSchema = brandedId('ProductCategoryId');
