...
| [0016](0016-template-defaults-and-overrides.md) | Template defaults, tenant overrides, revisions and revert         | Accepted                                     |
| [0017](0017-settings-registry.md)               | The typed settings registry; readable, versioned, no secrets      | Accepted                                     |
| [0018](0018-notifications.md)                   | Notification intent versus delivery attempt; real transports      | Accepted                                     |
| [0019](0019-feature-flags.md)                   | A feature flag is a boolean; its configuration is a setting       | Accepted                                     |
| [0020](0020-operational-events-phase-2.md)      | Operational events: read model, resolution, retention             | Accepted — extends 0007                      |
