...
| ------------------------- | ------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------- | ------------------------------------------- | ---------------------------------------------------------------------------------- |
| `/` Dashboard             | readiness, panel page, open management conditions | `system/readiness`, `panels`, `ops-log?scope=MANAGEMENT_CONDITIONS&open=true` | read                          | AVAILABLE NOW                               | `tests/web/dashboard.test.tsx`                                                     |
