...
| WP8-05 | a percentage discount rounds up, in the customer's favour                  | `discountAmountMinor` truncates                                        | `pricing-engine.test.ts` › never goes below one minor unit, and rounds a percentage up for the customer                  | KILLED |
